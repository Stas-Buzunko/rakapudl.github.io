(function(){
var cs = document.getElementById('mycountdown8');
var now = new Date();

			var mcD = document.getElementById('mycountDay8');
			var mcDE = document.getElementById('mcDEID8');
			
			var mcH = document.getElementById('mycountHour8');
			var mcHE = document.getElementById('mcHEID8');
			
			var mcM = document.getElementById('mycountMin8');
			var mcME = document.getElementById('mcMEID8');
			
			var mcS = document.getElementById('mycountSec8');
			var mcSE = document.getElementById('mcSEID8');
